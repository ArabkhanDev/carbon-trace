...
public interface UserCarbonDataMapper {
    ...
    @Mapping(target = "recreationalCulturalSportingActivities", source = "secondary.sportingActivities")
    ...
    @Mapping(target = "secondary.sportingActivities", source = "recreationalCulturalSportingActivities")
    ...
    @Mapping(target = "recreationalCulturalSportingActivities", source = "secondary.sportingActivities", defaultValue = "0")
