...
public class UserCarbonDataServiceImpl implements UserCarbonDataService {
    ...
    @Override
    public double calculateEnergy(Long id) {
        UserCarbonData userCarbonData = repository.findById(id)
    ...
    @Override
    public double calculateSecondary(Long id) {
        UserCarbonData userCarbonData = repository.findById(id)
                .orElseThrow(() -> new EntityNotFoundException("UserCarbonData not found for id: " + id));
        ...
        return secondaryEmissions;
    }

    @Override
    public double calculateTransport(Long id) {
        UserCarbonData userCarbonData = repository.findById(id)
                .orElseThrow(() -> new EntityNotFoundException("UserCarbonData not found for id: " + id));
    ...
    @Override
    public double calculateVehicle(Long id) {
        UserCarbonData userCarbonData = repository.findById(id)
                .orElseThrow(() -> new EntityNotFoundException("UserCarbonData not found for id: " + id));
    ...
    @Override
    public UserDataCalculatedResponse calculateTotal(Long id) {
        UserDataCalculatedResponse response = new UserDataCalculatedResponse();
        response.setEnergy(calculateEnergy(id));
        response.setSecondary(calculateSecondary(id));
        response.setTransport(calculateTransport(id));
        response.setVehicle(calculateVehicle(id));
        response.setTotal(calculateEnergy(id) + calculateSecondary(id) + calculateTransport(id) + calculateVehicle(id));
        return response;
    }
